...
This document defines how **dev** and **prod** environments differ across infrastructure, data, security, and operations. It also defines the promotion model (how changes move from dev to prod).

The goal is to keep environments **simple but credible**:
- Dev supports fast iteration and experimentation
- Prod is stable, reproducible, and audit-friendly
